...
|-------|---------------|--------|
|**HTML CSS Suport**| Ayuda con sintaxis y autocompletado en HTML y CSS| ![HTML CSS](Imagenes/HTMLCSSS.png)
|**Live Preview**| Permite revisar el estado de tu pagina en HTML| ![Live Preview](Imagenes/LivePreview.png)
|**Markdown All in One**| Visualizar presentación en Markdown | ![Markdown](Imagenes/Markdown.png)
|**XML - Red Hat**| Soporte para el lenguaje XML y su autocompleatdo|![XML](Imagenes/XML.png)
